...
<div class="content">
    <form action="${pageContext.request.contextPath}/pay/goAlipay" method="post">
        <div class="order_div">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div class="order_name">
                        <span>bill together: ${fn:length(requestScope.productOrder.productOrderItemList)}</span>
                    </div>
                </c:otherwise>
            </c:choose>
            <div class="order_price">service price：
                <span class="price_value">${requestScope.orderTotalPrice}</span>
                <span class="price_unit">dollars</span>
            </div>
            <div class="order_code">order no.：
            ...
            <a href="${pageContext.request.contextPath}/order/0/10" class="btn btn-danger">pay now</a>
        </div>
    </form>
