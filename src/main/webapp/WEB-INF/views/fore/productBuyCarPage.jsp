                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success !== true) {
                            alert("The deletion of shopping cart items is abnormal, please try again later");
                        }
...
<div class="content">
    <c:choose>
        <c:when test="${fn:length(requestScope.orderItemList)<=0}">
            ...
            <div id="empty">
                <h2>Your shopping cart is still empty, act now! you can:</h2>
                <ul>
                    <li>Review<a href="${pageContext.request.contextPath}/order">Products bought before</a></li>
                </ul>
            </div>
        </c:when>
        <c:otherwise>
            ...
            <table id="J_CartMain">
                ...
                <tr>
                    ...
                    <th width="120px"><span>total price</span></th>
                    <th width="84px"><span>manipulate</span></th>
                    <th hidden>ID</th>
                </tr>
                </thead>
                <tbody>
...
<div class="modal fade" id="modalDiv" tabindex="-1" role="dialog" aria-labelledby="modalDiv" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">Sure to delete this product？</div>
