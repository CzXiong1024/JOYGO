...
<nav>
    ...
    <div class="header">
        <a href="${pageContext.request.contextPath}"><img
                src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/joygo.jpg" height="60" width="200"></a>
...
<div class="loginDiv">
    ...
    <div class="loginMessage">
        <div class="loginMessageMain">
            ...
            <img src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/scan-safe.png"/><span>Scan to log in</span>
        </div>
    </div>
    <div class="pwdLogin">
    ...
    <div class="qrcodeLogin">
        <span class="loginTitle">Scan to log in</span>
        ...
        <div class="qrcodeFooter">
            ...
            <p>打开 <a href="https://mall.uzykj.com"></a> | <a
                    href="https://uzykj.com/m"></a>Scan to log in</p>
        </div>
        <div class="loginLinks">
            <a href="JavaScript:void(0)" id="pwdLogin">Password to log in</a>
            <a href="#">register</a>
        </div>
    </div>
</div>
...
<div class="context">
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li>Total comment<span>${requestScope.product.product_review_count}</span></li>
            <li class="tmall_points">get points<span><fmt:formatNumber type="number"
        ...
        <dl class="context_info_member">
            <dt>quantity</dt>
            <dd>
                <input type="text" value="1" maxlength="8" title="Please enter the quantity" class="context_buymember">
    ...
    <div class="J_TabBarBox">
        <ul>
            <li class="J_GoodsDetails">
                <a href="javascript:void(0)" class="detailsClick" onclick="getDetailsPage(this,'J_details')">product detail</a>
            </li>
            <li class="J_GoodsReviews">
                <a href="javascript:void(0)"
                   onclick="getDetailsPage(this,'J_reviews')">total comment<span>${requestScope.product.product_review_count}</span></a>
            </li>
        </ul>
    </div>
    <div class="J_choose">
