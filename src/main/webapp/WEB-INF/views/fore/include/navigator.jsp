    ...
    <div class="nav_main">
        <p id="container_login">
            <c:choose>
                <c:when test="${requestScope.user.user_name==null}">
                    <em>Hi, Wellcome to Joy Go online shop</em>
                    <a href="${pageContext.request.contextPath}/login" style="color:#FA0808">Log In</a>
        ...
        <li class="quick_li_cart">
            ...
            <li class="quick_li_MyTaobao">
                <div class="sn_menu">
                 <a href="${pageContext.request.contextPath}/order/0/10">My Orders</a>
                </div>
            </li>
            <li class="quick_li_cart">
                <img src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/buyCar.png">
                <a href="${pageContext.request.contextPath}/order/cart">Shopping Cart</a>
            </li>
        </ul>
    </div>
</div>