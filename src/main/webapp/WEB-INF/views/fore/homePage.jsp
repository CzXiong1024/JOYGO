...
<meta http-equiv="X-UA-Compatible" content="IE=Edge"/>
    ...
    <title>Joy Go -- Online Shopping Mall</title>
</head>
<style>
...
<script>
    ...
    <div class="header">
         <a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/joygo.jpg"></a>
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="Search Product"
                           maxlength="50">
    ...
    <div class="header-wrap">
	    <div class="home_nav">
		   <a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/joygo.jpg"></a>
	            ...
	            <form action="${pageContext.request.contextPath}/product" method="get">
	                <div class="mallSearch-input">
	                    <input class="header_search_input" type="text" name="product_name" placeholder="Search phone PC components"
	                           maxlength="50">
	                    <input class="header_search_button" type="submit" value="Search">
	                </div>
	            </form>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="5000">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="carousel-image" style="background-image:url(https://static.vecteezy.com/system/resources/previews/004/299/835/original/online-shopping-on-phone-buy-sell-business-digital-web-banner-application-money-advertising-payment-ecommerce-illustration-search-free-vector.jpg);background-size:100% 100%;">
            ...
            <div class="item">
                <div class="carousel-image"
                     style="background-image: url(https://img.lovepik.com//photo/40007/3495.jpg_860.jpg);background-size:100% 100%;">
            ...
            <div class="item">
                <div class="carousel-image"
                     style="background-image: url(https://i.ytimg.com/vi/-EcLfqsOpSM/maxresdefault.jpg);background-size:100% 100%;">
                    <div class="carousel-caption "></div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="carousel-image"
                     style="background-image: url(https://www.w3care.com/images/uploads/industry-vertical/ecommerce-shopping-banner.jpg);background-size:100% 100%;">
                    <div class="carousel-caption "></div>
                </div>
            </div>
