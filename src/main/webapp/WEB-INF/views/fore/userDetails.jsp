...
<head>
    <script src="${pageContext.request.contextPath}/static/js/fore/fore_userDatiles.js"></script>
    <link href="${pageContext.request.contextPath}/static/css/fore/fore_userDatiles.css" rel="stylesheet">
    ...
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}"><img
                    src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/joygo.jpg"><span
                    class="span_tmallRegister">User Center</span></a>
        </div>
    </div>
</nav>
<div class="content">
    <div class="mt-menu" id="J_MtSideMenu">
        <div class="mt-avatar">
            <img src="${pageContext.request.contextPath}/static/images/item/userProfilePicture/${requestScope.user.user_profile_picture_src}"
    ...
    <div class="sns-config" id="profile">
        ...
        <div class="sns-main">
            <div id="tips-box">
                ...
                <label  class="font_we">Filling in real information will help friends find you</label>
            </div>
            <form action="${pageContext.request.contextPath}/user/update" method="post" id="register_form">
                <div class="form-item">
                    <label class="form-label tsl">Current Avatar：</label>
                ...
                <div class="form-item">
                    ...
                    <input name="user_password_one" type="password" id="user_password_one" class="form-text err-input"
                           placeholder="Enter again" maxlength="20">
                    <span class="form_span"></span>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    <label class="form-label tsl">DoB：</label>
