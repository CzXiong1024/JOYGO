...
<div class="headerLayout">
    <div class="headerContext">
        ...
        <ol class="header-extra">
            ...
            <li class="step-no">
                <div class="step-name">confirm the receipt of goods</div>
                <div class="step-no">3</div>
            </li>
            <li class="step-no">
                <div class="step-name">comment</div>
...
<div class="content">
    <div class="order_address">
        ...
        <label for="select_order_address_province">location</label><span class="mustValue">*</span>
...
<%--        </select>--%>
        <div class="br"></div>
        <label for="textarea_details_address" id="label_details_address">address</label><span class="mustValue">*</span>
        <textarea id="textarea_details_address">${requestScope.detailsAddress}</textarea>
        <div class="br"></div>
        <label for="input_order_post" style="min-width: 80px;" id="label_order_post">post code</label><span></span>
        ...
        <div class="br"></div>
        <label for="input_order_phone" id="label_order_phone">phone number</label><span class="mustValue">*</span>
            ...
            <c:forEach items="${requestScope.orderItemList}" var="orderItem" varStatus="i">
                ...
                <tr class="tr_userMessage">
                    <td><label for="input_userMessage_${i.count}">Remark：</label><textarea maxlength="500"
                                                                                       ...
                                                                                       placeholder="Optional: fill in the content has been negotiated and confirmed with the seller"
                ...
                <tr class="tr_orderCount">
                    <td colspan="3"></td>
                    <td><span class="span_price_name">Total</span><span
        ...
        <div class="order_count_div_main">
            <div class="order_count_div_content">
                ...
                <h1 class="order_count_div_address">
                    <span class="order-title">deliver to：</span><span class="order-value address_province"></span><span
    ...
    <script>
        function payOne() {
            ...
            $.ajax({
                ...
                error: function () {
                    alert("There was a problem with order submission, please resubmit!");
                    location.reload(true);
                }
            });
        }
