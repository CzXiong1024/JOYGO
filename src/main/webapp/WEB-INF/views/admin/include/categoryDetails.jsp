    ...
    <script>
        $(function () {
            ...
            $(".details_picList").on("click", "li:not(.details_picList_fileUpload)", function () {
                ...
                $(".modal-body").text("Sure to delete the image for this category？");
                $('#modalDiv').modal();
            });
            //单击取消按钮时
        ...
        function uploadImage(fileDom) {
            ...
            if (file === undefined || !imageType.test(file.type)) {
                ...
                $(".modal-body").text("Please choose an image！");
                $('#modalDiv').modal();
                return;
            }
            //判断大小
            if (file.size > 512000) {
                ...
                $(".modal-body").text("The size of the image cannot exceed 500KB！");
                $('#modalDiv').modal();
                return;
            }
            //清空值
...
<div class="details_div_first">
    ...
    <div class="frm_div">
        <label class="frm_label text_info" id="lbl_category_id">Category No.</label>
        <span class="details_value" id="span_category_id">system specific</span>
    </div>
    <div class="frm_div">
...
<div class="details_div details_div_last">
    <c:if test="${fn:length(requestScope.category.propertyList)!=0}">
        <span class="details_title text_info">Proporty List</span>
...
<div class="modal fade" id="modalDiv" tabindex="-1" role="dialog" aria-labelledby="modalDiv" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">Sure to delete the image？</div>
