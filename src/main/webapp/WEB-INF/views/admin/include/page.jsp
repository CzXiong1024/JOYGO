...
<div id="pageDiv">
    <ul>
        <li data-name="firstPage" <c:if test="${!requestScope.pageUtil.isHasPrev()}">class="disabled" </c:if>>
            <a href="javascript:void(0)" onclick="getPage(0)" aria-label="homepage"><span
                    aria-hidden="true">&laquo;</span></a>
        </li>
        <li data-name="prevPage" <c:if test="${!requestScope.pageUtil.isHasPrev()}">class="disabled" </c:if>>
            <a href="javascript:void(0)" onclick="getPage(${requestScope.pageUtil.index-1})" aria-label="previous page"><span
        ...
        <li data-name="lastPage" <c:if test="${!requestScope.pageUtil.isHasNext()}">class="disabled" </c:if>>
            <a href="javascript:void(0)" onclick="getPage(${requestScope.pageUtil.getTotalPage()-1})" aria-label="final page">&raquo;</a>
        </li>
    </ul>
</div>
