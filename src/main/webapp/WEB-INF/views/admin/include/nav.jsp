...
<nav id="nav_main" class="text_info">
    ...
    <span id="txt_home_title" class="nav_text">Data Management Background</span>
    ...
    <img id="img_home_profile_picture"
         ...
         alt="avatar" title="avatar" width="32px" height="32px">
    <input id="admin_id" type="hidden" value="${requestScope.admin.admin_id}"/>
    <ul id="nav_tools">
        <li id="nav_tools_admin_manage">Account Management</li>
        <li id="nav_tools_admin_logout">Log Out</li>
    </ul>
</nav>