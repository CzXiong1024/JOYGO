                        ...
                        for (var i = 0; i < data.productOrderList.length; i++) {
                            ...
                            switch (data.productOrderList[i].productOrder_status) {
                                case 0:
                                    ...
                                    productOrderStatusTitle = "Waiting for the user to pay";
                                    productOrderStatus = "Waiting for the user to pay";
                                    break;
                                case 1:
                                    productOrderStatusClass = "td_warn";
                                    productOrderStatusTitle = "User has paid, waiting for the seller shipping";
                                    productOrderStatus = "waiting for the seller shipping";
                                    break;
                                case 2:
