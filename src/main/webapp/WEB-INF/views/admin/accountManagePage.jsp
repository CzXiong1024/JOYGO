            ...
            $("#btn_admin_save").click(function () {
                ...
                if ($(".modifyPwd").css("display") === "block") {
                    ...
                    if (admin_newPassword === "") {
                        styleUtil.errorShow($("#text_newPassword_details_msg"), "enter the new password");
                        return;
                    }
                    if (admin_confirmPassword === "") {
                        styleUtil.errorShow($("#text_confirmPassword_details_msg"), "enter the new password again");
                        return;
                    }
                    if (admin_password === admin_newPassword) {
                        styleUtil.errorShow($("#text_newPassword_details_msg"), "new password cannot be the same as the old one");
                        return;
                    }
                    if (admin_newPassword !== admin_confirmPassword) {
                        styleUtil.errorShow($("#text_confirmPassword_details_msg"), "Not the same!");
                        return;
                    }
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        $(".modal-body").text("Successfully saved！");
                        $('#modalDiv').modal();
                    } else {
                ...
                beforeSend: function () {
                    $("#btn_admin_save").attr("disabled", true).val("saving...");
                },
                error: function () {
        ...
        function uploadImage(fileDom) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        $("#admin_profile_picture").addClass("new").attr("src", "${pageContext.request.contextPath}/static/images/item/adminProfilePicture/" + data.fileName);
                    } else {
                        alert("图片上传异常！");
                    }
                },
