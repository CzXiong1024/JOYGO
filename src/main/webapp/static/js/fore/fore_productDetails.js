$(function () {
    ...
    $(".loginForm").unbind("submit").submit(function () {
        ...
        $(this).find(":text,:password").each(function () {
            if ($.trim($(this).val()) === "") {
                styleUtil.errorShow($("#error_message_p"), "Enter username & password！");
                yn = false;
                return yn;
            }
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        styleUtil.errorShow($("#error_message_p"), "Wrong jsername or password！");
                    }
                },
                error: function (data) {
                    $(".loginButton").val("Log in");
                    styleUtil.errorShow($("#error_message_p"), "Sever Error!");
                },
                beforeSend: function () {
